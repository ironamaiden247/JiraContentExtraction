...
for projectkey in projectkeys:
    ...
    if 'total' not in parsed_json:
        print('Unable to get bug total for project: ' + str(projectkey))
        continue
    ...
    while (i < 1):
        ...
        for bug in projissue:
            ...
            if rep_name != ass_disp:
                ...
                val1 = (
                projectkey, bugkey, bugname, priorityname, statusname, resolutionname, affect_versionname, compontstr,
                fix_version_name, labelstr, environmentstr, assignname, reportername, str(votecount), str(watchCount),
